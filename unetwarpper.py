...
'''
The purpose of this class is to store attention maps for each layer of the UNet model during training.
'''
...
class FrozenCLIPEmbedder(nn.Module):
    ...
    def __init__(self,
                 ...
                 device="cuda",
                 cache_dir="/home/wangye/Code/3D_SD_knowledge_base/Code/checkpoints",
                 max_length=77, pool=True):
        super().__init__()
